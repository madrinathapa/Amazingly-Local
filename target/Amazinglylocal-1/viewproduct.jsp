            ...
            <div class="container">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box">
                        ...
                        <% Inventory prod = (Inventory)session.getAttribute("inventoryId");		
                        long id=prod.getInventoryId();
						String image=prod.getImageName();
						String name=prod.getProductName();
						int quantity=prod.getQuantity();
						float price=prod.getPrice();
						float calory=prod.getCalories();
					String descriptions=prod.getDescription(); %>
                    ...
                    <p>
                           <h4> Ratings for this product</h4>    
                           <% ArrayList<Rating> reviewlist = (ArrayList<Rating>)session.getAttribute("ratings");	
                        		   ListIterator<Rating> it=reviewlist.listIterator();
                        		   int total=0;
                        		   int count=0;
                        		   while(it.hasNext())
                        		   {
                        			   Rating review=it.next();
                        			   if(review!=null){
                        		   long rate=review.getRating();
                        		   total+=rate;
                        		   count++;
