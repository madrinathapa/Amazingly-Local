            ...
            <div class="container">
                ...
                <div class="col-md-12" id="basket">
                    ...
                    <div class="box">
                        ...
                        <form action="@{/getSaleApprovals}" method="get">
                            <h1>Products</h1>
                        ...
                        <form action="approvesale" method="post" id="approveform" name="approveform">
                        <input id="approve" type="submit" value="approve" onClick="approveSale();">
                        </form>
                        </div>
...
//}
 ...
 _________________________________________________________ -->
    ...
    <script src="js/Pages/saleapprove.js"></script>
