                    ...
                    <div class="row products">
                        ...
                        <div class="col-md-3 col-sm-4">
                            <div class="product">
                                    ...
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="RecipeDetail.html">
                                                <img src="img/recipe1.jpeg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="RecipeDetail.html">
                                                <img src="img/recipe1a.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="text">
                                    <h3><a href="RecipeDetail.html">Roasted Celery Root with Cumin and Parsley</a></h3>
                                    <p class="buttons">
