                        ...
                        <form action="addrecipe" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <TEXTAREA id="Ingredients" rows="4" cols="20" class="form-control" name="ingredients"></TEXTAREA> 
                            </div>
                            <div class="form-group">
                                <label for="Instructions">Instructions</label>
                				<TEXTAREA id="Instructions" rows="4" cols="20" class="form-control" name="instructions"></TEXTAREA> 
                            </div>
                            <div class="form-group">
                            <label for="RecipeImage">Upload Picture</label>
                                <input type="file" name="RecipeImage" accept="image/*" class="form-control">                             
                            </div>
                            <div class="form-group">
                                <label for="Description">Description</label>
                                <TEXTAREA id="Description" rows="4" cols="20" class="form-control" name="description"></TEXTAREA> 
                            </div>
