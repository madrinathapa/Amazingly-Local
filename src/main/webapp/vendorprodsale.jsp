...
<!-- scripts -->
<script src="<c:url value="assets/script/jquery-3.1.0.min.js" />" type="text/javascript"></script>
...
<body>
 ...
 _________________________________________________________ -->
    ...
    <div id="all">
        ...
        <div id="content">
            <div class="container">
                ...
                <div class="col-md-12" id="basket">
					...
					<jsp:include page="vendorprodsalechart.jsp" />
        ...
        <!-- *** FOOTER ***
 _________________________________________________________ -->
        <div id="footer" data-animate="fadeInUp" style="display:none">
            <div class="container">
                <div class="row">
