                    ...
                    <div class="box">
                        ...
                        <hr>
                         ...
                         <form action="save" method="post" name="customer_form" id="customer_form">
                            ...
                            <div class="form group">
                            <label for="option">Security Question</label>
                            <br />
                                <select name="securityq">
                           		<option value="What is your mother's last name?">What is your mother's last name?</option>
								<option value="What is the name of your first pet?">What is the name of your first pet?</option>
								<option value="What is name of your kindergarden school?">What is name of your kindergarden school?</option>
							</select>
                            </div>
                            <div class="form group">
                            <label for="SAnswer">Security Answer</label>
                            <input type="text" class="form-control" name="securitya">
                            </div>
                            <div class="form-group">
                        ...
                        <form action="savevendor" method="post" name="vendor_form" id="vendor_form" style="display:none">
                         <div class="form-group">
                            ...
                            <div class="form-group">
                             ...
                             <input type="hidden" class="form-control" name="usertype" value="vendor">
