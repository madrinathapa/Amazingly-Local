...
<body>
 ...
 _________________________________________________________ -->
            ...
            <div class="container">
                ...
                <div class="col-md-12" id="basket">
                    ...
                    <div class="box">
                        ...
                        <form action="@{/getProductApprovals}" method="get">
                            <h1>Products</h1>
                            <p class="text-muted">You currently have the following pending approvals.</p>
                                                      <!-- /.table-responsive -->
                        ...
                        <form action="processpurchase" method="post" id="approveform" name="approveform">
                        <input id="approve" type="submit" value="Process purchase" onClick="approveSale();">
                        </form>
                        </div>
	...
	var s;
	s = jQuery("#saleTable").jqGrid('getGridParam','selarrrow');
	var theForm = document.forms['approveform'];
...
//}
 ...
 _________________________________________________________ -->
    ...
    <script src="js/Pages/vendorproductapprove.js"></script>
