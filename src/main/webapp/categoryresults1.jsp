            ...
            <div class="container">
                ...
                <div class="col-md-12">
                    ...
                    <div class="row products">
 					<% int count=0;
					ArrayList<InventoryMini> product = (ArrayList<InventoryMini>) session.getAttribute("displayresults");
					ListIterator<InventoryMini> prod=product.listIterator();
                    while(prod.hasNext()) 
					{
                    	count++;
                    	InventoryMini item=prod.next();
  					 %>
                            ...
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="viewproduct?inventoryId=<%=item.getInventoryId()%>">
                                                <img src="<%=item1.getImageName()%>" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="viewproduct?inventoryId=<%=item.getInventoryId()%>">
                                ...
                                <div class="text">
                                    <h3><a href="viewproduct?inventoryId=<%=item.getInventoryId()%>"><%=item1.getProductName() %></a></h3>
                                    <p class="buttons">
                                        <a href="viewproduct?inventoryId=<%=item.getInventoryId()%>" class="btn btn-default">View detail</a>
                                    </p>
                                </div>
