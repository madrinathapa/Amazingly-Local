...
<%@page import="com.iu.amazelocal.db.RecipeDetailCrud"%>
        ...
        <div id="content">
            <div class="container">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box">
                        <% Recipe rec = (Recipe)session.getAttribute("Rec");
						RecipeDetailCrud vrec=new RecipeDetailCrud();  
						String name=rec.getRecipeName();
						String ingredients=rec.getIngredients();
						String instructions=rec.getInstructions();
						String image=rec.getRecipeImage();
					String descriptions=rec.getDescription(); %>
